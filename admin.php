    ...
    <section id="menu" class="menu section-bg">
      ...
      <div class="section-title" style='margin-top: 100px;' >
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100" >
          ...
          <!-- form baslangic.................................................................................................... -->
            <form method="post" action="adminback.php" style="width: 500px;">
            <label for="menu_name">Yemek Adı:</label><br>
            <input type="text" id="menu_name" name="menu_name" style="width: 100%;"><br>
            ...
            <input type="text" id="menu_price" name="menu_price" style="width: 100%;"><br>

            <label for="menu_ex">Açıklama:</label><br>
            <textarea id="menu_ex" name="menu_ex" rows="4" style="width: 100%;"></textarea><br>
            <input type="submit" value="Yemek Ekle" style="width: 100%;">
        </form>
